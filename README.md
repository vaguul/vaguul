...
- [oss-maintainer-snapshot v0.1.0](https://github.com/vaguul/oss-maintainer-snapshot/releases/tag/v0.1.0) - released a read-only CLI for GitHub maintenance queue reports with tests and security baseline.
